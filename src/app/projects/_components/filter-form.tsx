              ...
              >
                <Checkbox 
                  ...
                  onCheckedChange={(checked: CheckedState) => {
                    const updatedTypes = checked ? [...selectedTypes, type.value] : selectedTypes.filter(item => item !== type.value);
            ...
            {TECHNOLOGIES.map(technology => (
              ...
              >
                <Checkbox 
                  ...
                  onCheckedChange={(checked: CheckedState) => {
                    const updatedStack = checked ? [...selectedStack, technology.value] : selectedStack.filter(item => item !== technology.value);
